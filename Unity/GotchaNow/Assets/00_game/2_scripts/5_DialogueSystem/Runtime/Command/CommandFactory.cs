...
namespace DialogueSystem.Runtime.Command
{
    public static class CommandFactory
    {
        ...
        public static DialogueCommand CreateEventCommand(CommandData data, DialogueEvent[] events) => new EventCommand(data.StartPosition, data.MustExecute, data.StringValue, events);
    }
}